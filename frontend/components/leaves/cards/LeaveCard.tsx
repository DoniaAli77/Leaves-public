...
export default function LeaveCard({ name, code, description, onEdit, onDelete }: Props) {
  return (
      ...
      <div className="flex justify-between items-start gap-3">
        <div className="flex-1">
          <div className="flex items-baseline gap-3">
            ...
            {code && <span className="text-xs px-2 py-1 bg-white/5 rounded text-gray-300">{code}</span>}
          </div>
